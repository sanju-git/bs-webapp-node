...
app.post('/upload', upload.single('audio'), async (req, res) => {
  ...
  try {
    ...
    const sessionState = req.body.sessionStateBase64 ?
      compressAndEncodeBase64(req.body.sessionStateBase64) :
    ...
    // Cleanup: Remove the uploads folder
    cleanUploadsFolder('uploads/');
  }
});
...
function cleanUploadsFolder(folderPath) {
